...
export OUT_REF="/home/lidamaha/1-StageM2/9-Nombre_de_copies/PureCN/Pipeline/5-normaldb/references_b1_11"
export DIR="/home/lidamaha/1-StageM2/9-Nombre_de_copies/PureCN/Pipeline"

Rscript $PURECN/NormalDB.R \
	--out-dir $OUT_REF \
	--coverage-files $DIR/3-normal_coverages/b1/normal_coverages_b1_11.list \
	--genome hg38 \
	--assay agilent_v6
