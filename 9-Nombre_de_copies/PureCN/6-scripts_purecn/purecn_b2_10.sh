...
export OUT_REF="/home/lidamaha/1-StageM2/9-Nombre_de_copies/PureCN/Pipeline/5-normaldb/references_b2_10"
...
export SAMPLEID="D210295"

mkdir $OUT/$SAMPLEID
Rscript $PURECN/PureCN.R \
	--out $OUT/$SAMPLEID \
	--tumor $DIR/2-coverage/b2/${SAMPLEID}_S11_coverage_loess.txt.gz \
	--sampleid $SAMPLEID \
