...
export OUT_REF="/home/lidamaha/1-StageM2/9-Nombre_de_copies/PureCN/Pipeline/5-normaldb/references_b2_5"
...
export SAMPLEID="D210294"

mkdir $OUT/$SAMPLEID
Rscript $PURECN/PureCN.R \
	--out $OUT/$SAMPLEID \
	--tumor $DIR/2-coverage/b2/${SAMPLEID}_S9_coverage_loess.txt.gz \
	--sampleid $SAMPLEID \
